...
- A Go-owned live-E2E harness now exists in `internal/agent/live_e2e_test.go`, and `make -C go e2e` is the supported entrypoint for the remaining real Linear/Codex validation.
